...
class ImageToArrayConverter(object):
    ...
    def __init__(self, src):
        ...
        cntrs, hier = cv2.findContours(thbw.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE) # Using RETR_EXTERNAL eliminates the error of capturing curves in a didgit as two digits
